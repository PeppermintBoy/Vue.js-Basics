...
import getPosts from '../composables/getPosts.js'; //composable function(a function stored in separate dedicated file)
// @ is an alias to /src
...
export default {
	...
	setup() {
		...
		//fetching data(db.json) and using COMPOSABLE function(separate file) in setup()
